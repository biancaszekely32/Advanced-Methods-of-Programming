...
public class MyHeap implements InterHeap {
    ...
    @Override
    public void update(Integer position, InterValue value) throws MyException {
    ...
    @Override
    public InterValue get(Integer position) throws MyException {
    ...
    public void remove(Integer key) throws MyException {
        ...
        if (!heap.containsKey(key))
            throw new MyException(String.format("%d is not present in the heap", key));
        heap.remove(key);
    }
